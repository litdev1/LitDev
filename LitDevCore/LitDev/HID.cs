...
namespace LitDev
{
    ...
    public static class LDHID
    {
        ...
        private static SBCallback _OnHIDInput = null;
        ...
        private static SBCallback _OnHIDRemoved = null;
        ...
        /// </summary>
        public static event SBCallback Input
        {
            add
            {
                _OnHIDInput = value;
        ...
        /// </summary>
        public static event SBCallback Removed
        {
            add
            {
                _OnHIDRemoved = value;
